...
def plot_chi2_fig(lab_specs, lab_all_specs, all_spec_types, score_type='p60', feat='raw_audioset_feats_096s', results_dir='fig_data_logo'):
    xs_auc = []
    ys_site_chi2 = []
    ys_hr_chi2 = []
    ys_site_hr_chi2 = []
    ...
    '''
    plt.scatter(xs_auc,ys_site_chi2)
    plt.ylabel('Site chi2')
    plt.xlabel('AUC')
    '''
    ...
    '''
    plt.figure()
    plt.scatter(xs_auc,ys_hr_chi2)
    plt.ylabel('Hour chi2')
    plt.xlabel('AUC')
    '''
    ...
    #plt.title(r'Pearson correlation: $\rho$ = {}, p = {}'.format(round(plt_rho,2), round(plt_p,10)))
